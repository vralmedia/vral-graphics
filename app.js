(function () {
  ...
  var PHONE = "17865911017";
  var MAX_FILE = 20 * 1024 * 1024;
  var ALLOWED = /\.(pdf|ai|psd|tif|tiff|jpg|jpeg|png|svg)$/i;

  var words = {
    en: {
      skip: "Skip to print desk", start: "Start a print job", heroTitle: "Printing for Less.",
      heroLead: "Cards, posters, boxes, and signs for Miami and US businesses.",
      heroNote: "Tell us what you need. We will reply on WhatsApp.", trust: "Part of Vral Media.",
      ...
      deskTitle: "Start your print job", deskLead: "Answer four short questions. A real person will reply on WhatsApp.",
      ...
      localFile: "This file stays on this device. Add it again after a page reload.", badFile: "We could not read this file. Try another file or continue without it.",
      ...
      waFail: "WhatsApp did not open. Copy your print brief below and send it to +1 786 591 1017.", showTicket: "Show job ticket", hideTicket: "Hide job ticket"
    },
    es: {
      skip: "Saltar al formulario", start: "Empezar un trabajo", heroTitle: "Impresión por menos.",
      heroLead: "Tarjetas, pósters, cajas y letreros para negocios en Miami y Estados Unidos.",
      heroNote: "Dinos qué necesitas. Te responderemos por WhatsApp.", trust: "Parte de Vral Media.",
      ...
      deskTitle: "Empieza tu trabajo", deskLead: "Responde cuatro preguntas cortas. Una persona te responderá por WhatsApp.",
      ...
      localFile: "Este archivo queda en este aparato. Debes agregarlo otra vez si recargas la página.", badFile: "No pudimos leer este archivo. Prueba otro o sigue sin archivo.",
      ...
      waFail: "WhatsApp no abrió. Copia la solicitud y envíala al +1 786 591 1017.", showTicket: "Ver solicitud", hideTicket: "Ocultar solicitud"
    }
  };
