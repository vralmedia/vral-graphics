(function (w, d) {
  ...
  function headerHTML(){
    ...
    return '<a class="skip-link" href="#content">'+t("skip")+'</a><header class="site-header shell">'+(privateChrome?'':'<button class="menu-toggle" type="button" data-menu-toggle aria-controls="site-menu" aria-expanded="false" aria-label="'+t("menu")+'"><span></span><span></span><span></span></button>')+'<a class="brand" href="'+r.home+'" aria-label="Vral Graphics home"><img src="'+markSrc()+'" width="43" height="43" alt=""><span class="brand-wordmark"><strong>Vral</strong><small>Graphics</small></span></a>'+nav+'<div class="header-actions">'+(privateChrome?'':'<a class="header-track" href="'+r.track+'">'+t("track")+'</a><a class="header-need" href="'+r.need+'">'+t("need")+'</a>')+'</div>'+(privateChrome?'':'<span class="mobile-header-spacer" aria-hidden="true"></span>')+'</header>'+(privateChrome?'':languageDockHTML());
  }
