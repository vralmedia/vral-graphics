(function (w, d) {
  "use strict";
  var COPY = {
    en: { skip:"Skip to content",products:"Products",work:"Work",offers:"Offers",language:"Language",help:"Help me choose",privacy:"Privacy",terms:"Terms",accessibility:"Accessibility",payment:"Payment terms",slogan:"Quality Printing for Less.",part:"Part of Vral Media.",menu:"Menu",copyright:"© 2026 Vral Graphics. Part of Vral Media." },
    es: { skip:"Saltar al contenido",products:"Productos",work:"Trabajos",offers:"Ofertas",language:"Idioma",help:"Ayúdame a elegir",privacy:"Privacidad",terms:"Términos",accessibility:"Accesibilidad",payment:"Términos de pago",slogan:"Impresión de calidad por menos.",part:"Parte de Vral Media.",menu:"Menú",copyright:"© 2026 Vral Graphics. Parte de Vral Media." }
  };
  ...
  function headerHTML(){
    ...
    var nav=privateChrome?"":'<nav class="site-nav" data-site-nav aria-label="Primary"><a href="'+r.need+'">'+t("products")+'</a><a href="'+r.work+'">'+t("work")+'</a><a href="'+r.offers+'">'+t("offers")+'</a></nav>';
